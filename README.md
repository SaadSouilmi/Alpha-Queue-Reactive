# Alpha Queue Reactive

A high-frequency market simulation framework based on the Queue Reactive (QR) model.
...
```
vcpkg automatically installs Arrow and Parquet on first build (takes ~10-20 min).
