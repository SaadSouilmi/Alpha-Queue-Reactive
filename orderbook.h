...
namespace qr {
    ...
    struct QueueDistributions {
        ...
        int32_t sample(Side side, int level, std::mt19937_64& rng) const {
            ...
            return static_cast<int32_t>(it - cp.begin());
        }
    };
    ...
    struct Order {
        ...
        // Timestamps
        int64_t ts; // Time sent
        int64_t tm; // Time reaches matching engine
        int64_t te; // Time executed
    ...
    public:
        ...
        void init(const std::vector<int32_t>& bid_prices,
